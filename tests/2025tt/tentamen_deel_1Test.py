...
def test_select_ordered_words (test):
    ...
    assert function_defined_in_module("select_ordered_words", "select_orderd_words")
    func = get_function("select_ordered_words", "select_orderd_words")
    assert no_input_output_in_function(func)
...
def test_word_lengths (test):
    ...
    assert function_defined_in_module("word_lengths", "word_length", "select_palindrome")
    func = get_function("word_lengths", "word_length", "select_palindrome")
    assert no_input_output_in_function(func)
